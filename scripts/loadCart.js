      ...
      return this.each(function () {
        ...
        priceBut.onclick = () => {
          if (cartPricesLoaded[0]) {
            ...
            let mail180180GrauCart = 0;
            let mail90180GrauCart = 0;
            let mail18090GrauCart = 0;
            let mailKosaGrauCart = 0;
            let mail180180KrivaGrauCart = 0;
            let mailKosaKrivaGrauCart = 0;

            let mail180180GrunCart = 0;
            let mail90180GrunCart = 0;
            let mail18090GrunCart = 0;
            let mailKosaGrunCart = 0;
            let mail180180KrivaGrunCart = 0;
            let mailKosaKrivaGrunCart = 0;

            for (let i = 0; i < allFences.length; i++) {
              if (fencesArr[i].color == "grau") {
                if (allFences[i][0].isVisible) mail180180GrauCart += 1;
                if (allFences[i][1].isVisible) mail90180GrauCart += 1;
                if (allFences[i][2].isVisible) mail18090GrauCart += 1;
                if (allFences[i][3].isVisible || allFences[i][4].isVisible)
                  mailKosaGrauCart += 1;
                if (allFences[i][5].isVisible) mail180180KrivaGrauCart += 1;
                if (allFences[i][6].isVisible || allFences[i][7].isVisible)
                  mailKosaKrivaGrauCart += 1;
              }
            ...
            cartItems.push(
              ...
              mail18090GrauCart,
              mailKosaGrauCart,
              mail180180KrivaGrauCart,
              mailKosaKrivaGrauCart,
              mail180180GrunCart,
              mail90180GrunCart,
              mail18090GrunCart,
              mailKosaGrunCart,
              mail180180KrivaGrunCart,
              mailKosaKrivaGrunCart,
              woodenPost190Grau,
              woodenPost95Grau,
              woodenPost190Grun,
              woodenPost95Grun,
