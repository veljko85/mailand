...
var createScene = function () {
  ...
  var mail90180Arr = [];
  var mail18090Arr = [];
  var mailKosaDesnaArr = [];
  var mailKosaLevaArr = [];
  var mail180180KrivaArr = [];
  var mailKosaDesnaKrivaArr = [];
  var mailKosaLevaKrivaArr = [];
  var allFences = [];
  ...
  function changePosAndScaleFence(valueToCount, activeFence) {
    ...
    fakeFences[activeFence].position.x = -1 + fenceSize / 2;

    if (
      fencesArr[activeFence].type == "mail90180" ||
      fencesArr[activeFence].type == "mailKosaDesna" ||
      fencesArr[activeFence].type == "mailKosaLeva" ||
      fencesArr[activeFence].type == "mailKosaDesnaKriva" ||
      fencesArr[activeFence].type == "mailKosaLevaKriva"
    )
      fakeFences[activeFence].position.x = 0.35;
  ...
  //MAIN POST MESH //////////////////////////////////////////////////////////////////////////
  BABYLON.SceneLoader.ImportMeshAsync("", "mesh/", "mainPostMail.glb").then(
    (result) => {
  ...
  var createRightFence = (posX, posZ, rotY, type) =>
    BABYLON.SceneLoader.ImportMeshAsync("", "mesh/", "mailCombo13.glb").then(
      (result) => {
        ...
        fakeFence.position = new BABYLON.Vector3(
          getAbsPosX(result.meshes[1]) - 0.1,
          0.9,
        ...
        let mail180180 = result.meshes[1];
        mail180180Arr.push(mail180180);
        mail180180.isVisible = false;

        let mail90180 = result.meshes[2];
        mail90180Arr.push(mail90180);
        mail90180.isVisible = false;

        let mail18090 = result.meshes[3];
        mail18090Arr.push(mail18090);
        mail18090.isVisible = false;

        let mailKosaDesna = result.meshes[4];
        mailKosaDesnaArr.push(mailKosaDesna);
        mailKosaDesna.isVisible = false;

        let mailKosaLeva = result.meshes[5];
        mailKosaLevaArr.push(mailKosaLeva);
        mailKosaLeva.isVisible = false;

        let mail180180Kriva = result.meshes[6];
        mail180180KrivaArr.push(mail180180Kriva);
        mail180180Kriva.isVisible = false;

        let mailKosaDesnaKriva = result.meshes[7];
        mailKosaDesnaKrivaArr.push(mailKosaDesnaKriva);
        mailKosaDesnaKriva.isVisible = false;

        let mailKosaLevaKriva = result.meshes[8];
        mailKosaLevaKrivaArr.push(mailKosaLevaKriva);
        mailKosaLevaKriva.isVisible = false;
        ...
        if (type == "mail180180") mail180180.isVisible = true;

        if (type == "mail90180") {
          mail90180.isVisible = true;
          setSmallerFenceSize(
            rightPost,
            rightPostCap,
            foundationRight,
        ...
        if (type == "mailKosaDesna") {
          mailKosaDesna.isVisible = true;
          rightWoodPost.scaling.y = 0.524;
          rightWoodPost.position.y = 0.532;
          rightPost.scaling.z = 0.524;
          rightPost.position.y = 0.504;
        ...
        if (type == "mailKosaLeva") {
          mailKosaLeva.isVisible = true;
          setSmallerFenceSize(
            rightPost,
            rightPostCap,
            foundationRight,
        ...
        if (type == "mail180180Kriva") mail180180Kriva.isVisible = true;

        if (type == "mailKosaDesnaKriva") {
          mailKosaDesnaKriva.isVisible = true;
          rightWoodPost.scaling.y = 0.524;
          rightWoodPost.position.y = 0.532;
          rightPost.scaling.z = 0.524;
          rightPost.position.y = 0.504;
        ...
        if (type == "mailKosaLevaKriva") {
          mailKosaLevaKriva.isVisible = true;
          setSmallerFenceSize(
            rightPost,
            rightPostCap,
            foundationRight,
  ...
  function handleTabActivnes() {
    if (!document.hidden) {
      createRightFence(0.99, 0, 0, "mail180180");
  ...
  let addNewFence180180Kriva = document.getElementById(
    "new-fence-180180-kriva"
  );
  addNewFence180180Kriva.onclick = () => {
    createNewFence(
      createRightFence,
      activeArrowSide,
      rightPosts,
  ...
  let addNewFenceKosaDesnaKriva = document.getElementById(
    "new-fence-kosa-desna-kriva"
  );
  addNewFenceKosaDesnaKriva.onclick = () => {
    createNewFence(
      createRightFence,
      activeArrowSide,
      rightPosts,
  ...
  let addNewFenceKosaLevaKriva = document.getElementById(
    "new-fence-kosa-leva-kriva"
  );
  addNewFenceKosaLevaKriva.onclick = () => {
    createNewFence(
      createRightFence,
      activeArrowSide,
      rightPosts,
  ...
  function setPhostenType(a, b) {
    ...
    leftPostCaps[0].isVisible = false;
    if (
      fencesArr[0].type == "mail18090" ||
      fencesArr[0].type == "mailKosaLeva" ||
      fencesArr[0].type == "mailKosaLevaKriva"
    ) {
    ...
    for (let i = 0; i < fencesArr.length; i++) {
      if (
        fencesArr[i].type == "mail18090" ||
        fencesArr[i].type == "mailKosaDesna" ||
        fencesArr[i].type == "mailKosaDesnaKriva"
      ) {
    ...
    for (let i = 0; i < fencesArr.length; i++) {
      if (
        ...
        for (let j = 0; j < fencesArr[i].children.length; j++) {
          if (
            fencesArr[fencesArr[i].children[j]].type != "mail18090" &&
            fencesArr[fencesArr[i].children[j]].type != "mailKosaLeva" &&
            fencesArr[fencesArr[i].children[j]].type != "mailKosaLevaKriva"
          ) {
  ...
  function changeFenceFunction(c, d, h) {
    ...
    if (d == "mail180180") mail180180Arr[h].isVisible = true;

    if (d == "mail90180") mail90180Arr[h].isVisible = true;

    if (d == "mail18090") mail18090Arr[h].isVisible = true;

    if (d == "mailKosaDesna") mailKosaDesnaArr[h].isVisible = true;

    if (d == "mailKosaLeva") mailKosaLevaArr[h].isVisible = true;

    if (d == "mail180180Kriva") mail180180KrivaArr[h].isVisible = true;

    if (d == "mailKosaDesnaKriva") mailKosaDesnaKrivaArr[h].isVisible = true;

    if (d == "mailKosaLevaKriva") mailKosaLevaKrivaArr[h].isVisible = true;
    ...
    if (d == "mail18090") {
      ...
      for (let i = 0; i < fencesArr[h].children.length; i++) {
        if (
          fencesArr[fencesArr[h].children[i]].type != "mail18090" &&
          fencesArr[fencesArr[h].children[i]].type != "mailKosaLeva" &&
          fencesArr[fencesArr[h].children[i]].type != "mailKosaLevaKriva"
        ) {
          childType += 1;
        }
      }
      ...
      if (h > 0 && fencesArr[h].parent != undefined) {
        if (
          fencesArr[fencesArr[h].parent].type == "mail18090" ||
          fencesArr[fencesArr[h].parent].type == "mailKosaDesna" ||
          fencesArr[fencesArr[h].parent].type == "mailKosaDesnaKriva"
        ) {
          let fenceSibling = 0;
          for (
            let i = 0;
      ...
      for (let i = 0; i < fencesArr.length; i++) {
        if (
          ...
          fencesArr[i].type != "mail18090" &&
          fencesArr[i].type != "mailKosaLeva" &&
          fencesArr[i].type != "mailKosaLevaKriva"
        ) {
          mainPostChildType += 1;
        }
      }
    ...
    if (d == "mailKosaDesna" || d == "mailKosaDesnaKriva") {
      //children
      let childType = 0;
      for (let i = 0; i < fencesArr[h].children.length; i++) {
        if (
    ...
    if (d == "mailKosaLeva" || d == "mailKosaLevaKriva") {
    ...
    if (d == "mail180180" || d == "mail90180" || d == "mail180180Kriva") {
      // ledsRight[h].scaling.z = 1;
      // ledsRight[h].position.z = 0;
      // ledsRight[h].position.y = 0.001;
      if (rightPosts[h].scaling.z < 0.6) {
  ...
  changeFence[0].addEventListener("click", () => {
    changeFenceFunction(180, "mail180180", activeFence);
  });
  changeFence[1].addEventListener("click", () => {
    changeFenceFunction(90, "mail90180", activeFence);
  });
  changeFence[2].addEventListener("click", () => {
    changeFenceFunction(180, "mail18090", activeFence);
  });
  changeFence[3].addEventListener("click", () => {
    changeFenceFunction(90, "mailKosaDesna", activeFence);
  });
  changeFence[4].addEventListener("click", () => {
    changeFenceFunction(90, "mailKosaLeva", activeFence);
  });
  changeFence[5].addEventListener("click", () => {
    changeFenceFunction(180, "mail180180Kriva", activeFence);
  });
  changeFence[6].addEventListener("click", () => {
    changeFenceFunction(90, "mailKosaDesnaKriva", activeFence);
  });
  changeFence[7].addEventListener("click", () => {
    changeFenceFunction(90, "mailKosaLevaKriva", activeFence);
  });
    ...
    if (fencesArr[activeFence].type == "mail180180") {
      for (let i = 0; i < fencesArr.length; i++) {
        if (activeFence != i && fencesArr[i].status != "disposedFence") {
          changeFenceFunction(180, "mail180180", i);
        }
      }
    }
    if (fencesArr[activeFence].type == "mail90180") {
      for (let i = 0; i < fencesArr.length; i++) {
        if (activeFence != i && fencesArr[i].status != "disposedFence") {
          changeFenceFunction(90, "mail90180", i);
        }
      }
    }
    if (fencesArr[activeFence].type == "mail18090") {
      for (let i = 0; i < fencesArr.length; i++) {
        if (activeFence != i && fencesArr[i].status != "disposedFence") {
          changeFenceFunction(180, "mail18090", i);
        }
      }
    }
    if (fencesArr[activeFence].type == "mailKosaDesna") {
      for (let i = 0; i < fencesArr.length; i++) {
        if (activeFence != i && fencesArr[i].status != "disposedFence") {
          changeFenceFunction(90, "mailKosaDesna", i);
        }
      }
    }
    if (fencesArr[activeFence].type == "mailKosaLeva") {
      for (let i = 0; i < fencesArr.length; i++) {
        if (activeFence != i && fencesArr[i].status != "disposedFence") {
          changeFenceFunction(90, "mailKosaLeva", i);
        }
      }
    }
    if (fencesArr[activeFence].type == "mail180180Kriva") {
      for (let i = 0; i < fencesArr.length; i++) {
        if (activeFence != i && fencesArr[i].status != "disposedFence") {
          changeFenceFunction(180, "mail180180Kriva", i);
        }
      }
    }
    if (fencesArr[activeFence].type == "mailKosaDesnaKriva") {
      for (let i = 0; i < fencesArr.length; i++) {
        if (activeFence != i && fencesArr[i].status != "disposedFence") {
          changeFenceFunction(90, "mailKosaDesnaKriva", i);
        }
      }
    }
    if (fencesArr[activeFence].type == "mailKosaLevaKriva") {
      for (let i = 0; i < fencesArr.length; i++) {
        if (activeFence != i && fencesArr[i].status != "disposedFence") {
          changeFenceFunction(90, "mailKosaLevaKriva", i);
        }
      }
    }
  ...
  function deleteFence(a) {
    ...
    if (
      ...
      (fencesArr[fencesArr[a].parent].type == "mial18090" ||
        fencesArr[fencesArr[a].parent].type == "mailKosaDesna" ||
        fencesArr[fencesArr[a].parent].type == "mailKosaDesnaKriva")
    ) {
      let childTypee = 0;
